...
#     X_group1 = pd.concat([data[data['region'] == 1]]).to_numpy()
#     X_group2 = pd.concat([data[data['region'] == 0]]).to_numpy()
#     X_group3 = pd.concat([data[data['region'] == 3]]).to_numpy()
#     X_group4 = pd.concat([data[data['region'] == 2]]).to_numpy()
#
...
if __name__ == '__main__':
    ...
    # #
    gm = GaussianMixture(n_components=4, covariance_type='diag', max_iter=10000, n_init=10)
    gm.fit(X_train)
